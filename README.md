...
<div align="center">
  <a href="docs/showcase.html">
    <img src="docs/agent-watch-demo.svg" width="100%" alt="Agent Watch live triage dashboard" />
  </a>
  <p><strong>Live triage</strong> · Multiple providers, attention states, stalled detection, local preview, exact tmux routing, and notification health.</p>
</div>

<table>
  <tr>
    <td width="50%" valign="top">
      <a href="docs/agent-watch-progress-demo.svg"><img src="docs/agent-watch-progress-demo.svg" width="100%" alt="Agent Watch global progress dashboard" /></a>
      <br /><strong>Global progress</strong><br />Provider-neutral Goal, Done, Current, Next, and Blocked snapshots for one session or all eligible sessions.
    </td>
    <td width="50%" valign="top">
      <a href="docs/agent-watch-recovery-demo.svg"><img src="docs/agent-watch-recovery-demo.svg" width="100%" alt="Agent Watch exited session recovery dashboard" /></a>
      <br /><strong>Safe recovery</strong><br />Retained exit history, clear availability reasons, and resume into a fresh independent tmux session.
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <a href="docs/agent-watch-shortcuts-demo.svg"><img src="docs/agent-watch-shortcuts-demo.svg" width="100%" alt="Agent Watch keyboard shortcut dashboard" /></a>
      <br /><strong>Keyboard workflow</strong><br />Search, filter, inspect, query progress, navigate, open panes, recover sessions, and refresh without leaving the terminal.
    </td>
    <td width="50%" valign="top">
      <a href="docs/showcase.html"><strong>Open the interactive HTML showcase →</strong></a>
      <br /><br />A responsive, tabbed tour of the dashboard and its local-first monitoring model.
      <br /><br /><code>agent-watch ui</code>
    </td>
  </tr>
</table>

All screenshots are generated by [`scripts/render-demo.py`](scripts/render-demo.py)
from deterministic synthetic content only. They include no real session names,
